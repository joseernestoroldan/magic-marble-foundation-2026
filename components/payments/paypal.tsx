...
const Paypal = () => {
  return (
    <Link href={"https://www.paypal.com/donate?hosted_button_id=8LVLMN3NBRABS"}>
      <div className=" w-60 h-40 border border-gray-300 flex flex-col justify-center items-center rounded-[5px] space-y-4 hover:bg-gray-50">
        <button className="flex space-x-4 rounded-[5px] bg-yellow-400  justify-center items-center h-12 w-52">
        ...
        <p className="text-cyan-600 text-base font-medium text-center mx-6 capitalize">
